...
function motopressCEDomainMappingNotice() {
    ...
    echo '<div class="error"><p>' . sprintf(__("Use the mapped domain to access the admin area. Find out <a href='%s' target='_blank'>here</a> how to setup it", 'motopress-content-editor'), esc_url($linkDomainMapping)) . '</p></div>';
}
...
function motopressCEHTML() {
	...
	$proBtnTitle = __("Duplicate Object", 'motopress-content-editor');
	$liteBtnTitle = __("This feature is only available in Pro version", 'motopress-content-editor');

	$duplicateBtnTitle = $proBtnTitle;
	$duplicateBtnAttrs = '';
?>
        ...
        <div class="motopress-content-editor-navbar">
            <div class="navbar-inner">
                ...
                <div class="motopress-page-name">
                    <span id="motopress-post-type"><?php echo get_post_type() == 'page' ? __("Page", 'motopress-content-editor') : __("Post", 'motopress-content-editor'); ?></span>:
	            ...
	            <div class="pull-left motopress-control-btns motopress-leftbar-control-btns">
                    <button class="motopress-btn-red" id="mpce-add-widget" title="<?php echo __("+ Add", 'motopress-content-editor'); ?>"><?php echo __("+ Add", 'motopress-content-editor'); ?></button>
                </div>
                <div class="pull-left motopress-control-btns motopress-object-control-btns">
	                ...
	                <button class="motopress-btn-default" id="motopress-content-editor-delete" title="<?php echo __("Delete Object", 'motopress-content-editor'); ?>"><div class="motopress-content-editor-delete-icon"></div></button>
                </div>
                <div class="pull-right navbar-btns">					
                    <button class="motopress-btn-blue<?php if ($post->post_status === 'publish') echo ' motopress-ajax-update'; ?>" id="motopress-content-editor-publish"><?php echo __("Publish", 'motopress-content-editor'); ?></button>
                    <button class="motopress-btn-default<?php if ($pagenow !== 'post-new.php') echo ' motopress-ajax-update'; ?>" id="motopress-content-editor-save"><?php echo __("Save", 'motopress-content-editor'); ?></button>
					<button class="motopress-btn-default" id="motopress-content-editor-preview"><?php echo __("Preview", 'motopress-content-editor'); ?></button>
					<button class="motopress-btn-default" id="motopress-content-editor-device-mode-preview" title="<?php echo __("Responsive Preview", 'motopress-content-editor'); ?>"><div></div></button>
                    <?php $isHideTutorials = apply_filters('mpce_hide_tutorials', false);
                    if (!$isHideTutorials) {
                        echo '<button class="motopress-btn-default btn-tutorials" id="motopress-content-editor-tutorials">' . _x("?", "Help" ,'motopress-content-editor') . '</button>';
                    }
                    ?>
                    <button class="motopress-btn-default" id="motopress-content-editor-close" title="<?php echo __("Close", 'motopress-content-editor'); ?>"><div></div></button>
                    <?php
                    $upgradeBtnTitle = __("Upgrade", 'motopress-content-editor');
                     ?>
                </div>
            </div>
        </div>
...
<!--			<div>
        ...
        <div id="motopress-tutorials-modal" class="motopress-modal modal motopress-soft-hide fade">
            <div class="modal-header">
                <p id="tutsModalLabel" class="modal-header-label"><?php printf(__("%s Help & Tutorials", 'motopress-content-editor'), $motopressCESettings['brand_name']); ?><button type="button" tabindex="0" class="close massive-modal-close" data-dismiss="modal" aria-hidden="true">&times;</button></p>
            </div>
        ...
        <div id="motopress-code-editor-modal" class="motopress-modal modal motopress-soft-hide fade" role="dialog" aria-labelledby="codeModalLabel" aria-hidden="true">
            <div class="modal-header">
                <p id="codeModalLabel" class="modal-header-label"><?php echo __("Edit", 'motopress-content-editor') . ' ' . __("WordPress Text", 'motopress-content-editor'); ?></p>
            </div>
            ...
            <div class="modal-footer">
                <button id="motopress-save-code-content" class="motopress-btn-blue"><?php echo __("Save", 'motopress-content-editor'); ?></button>
                <button class="motopress-btn-default" data-dismiss="modal" aria-hidden="true"><?php echo __("Close", 'motopress-content-editor'); ?></button>
            </div>
        </div>
        ...
        <div id="motopress-ce-save-preset-modal" class="motopress-modal modal motopress-soft-hide fade" role="dialog" aria-labelledby="codeModalLabel" aria-hidden="true">
            <div class="modal-header">
                <p id="codeModalLabel" class="modal-header-label"><?php echo __("Save Preset", 'motopress-content-editor'); ?></p>
            </div>
            <div class="modal-body">
				<p class="description motopress-ce-preset-inheritance motopress-hide"><?php echo __("Inherit properties from preset", 'motopress-content-editor'); ?> "<b class="motopress-ce-preset-inheritance-name"></b>"</p>
				...
				<div class="motopress-ce-save-preset-select-wrapper motopress-ce-modal-control-wrapper">
					<label for="motopress-ce-save-preset-select"><?php echo __("Choose Action:", 'motopress-content-editor'); ?></label>
					<select id="motopress-ce-save-preset-select">
						<option value=""><?php echo __("Create New Preset", 'motopress-content-editor'); ?></option>
						<optgroup label="<?php echo __("Save As Preset", 'motopress-content-editor'); ?>" class="<?php  echo empty($presets) ? 'motopress-hide' : ''; ?>">
				...
				<div class="motopress-ce-save-preset-name-wrapper motopress-ce-modal-control-wrapper">
					<label for="motopress-ce-save-preset-name"><?php echo __("Preset Name:", 'motopress-content-editor'); ?></label>
					<input type="text" id="motopress-ce-save-preset-name" name="preset-name" />
					<p class="description"><?php echo __("Leave this field blank to generate name automatically.", 'motopress-content-editor'); ?></p>
				</div>
            </div>
            <div class="modal-footer">
				<button id="motopress-ce-create-preset" class="motopress-btn-blue"><?php echo __("Create Preset", 'motopress-content-editor'); ?></button>
				<button id="motopress-ce-update-preset" class="motopress-btn-blue motopress-hide"><?php echo __("Update Preset", 'motopress-content-editor'); ?></button>
                <button class="motopress-btn-default" data-dismiss="modal" aria-hidden="true"><?php echo __("Close", 'motopress-content-editor'); ?></button>
            </div>
        </div>
    ...
    <div id="motopress-preload">
        ...
        <div id="motopress-error">
            <div id="motopress-error-title"><?php echo __("An internal error occurred during loading Visual Builder. Please submit this data to support team.", 'motopress-content-editor'); ?></div>
            ...
            <div class="motopress-terminate">
                <button id="motopress-terminate" class="motopress-btn-default"><?php echo __("Terminate & Close", 'motopress-content-editor'); ?></button>
            </div>
        </div>
...
//			    preloader.show();
		    ...
		    var setDefaultTitle = function() {
			    ...
			    if (!noTitle) noTitle = '<?php echo __("no title", 'motopress-content-editor'); ?>';
			    $title.val(noTitle);
                ...
                <?php if (extension_loaded('mbstring')) { ?>
                    <?php if ($motopressCEIsjQueryVer) { ?>
	                    ...
	                    <?php if ($userCanRichedit) { ?>
	                        ...
	                        if (!tinymceDefined) {
		                        alert('<?php echo __("WordPress visual editor is required", 'motopress-content-editor'); ?>');
		                        return;
	                        }
...
//                            sessionStorage.setItem('motopressPluginAutoSaved', false);
                        ...
                        <?php } else { ?>
	                        alert('<?php echo __("\"Disable the visual editor when writing option\" should be disabled in Your Profile settings to start page builder", 'motopress-content-editor'); ?>');
                        <?php } ?>
                        });
...
function motopressCEIsjQueryVerNotice() {
    echo '<div class="error"><p>' . sprintf(__("Minimum jQuery version - %s. Minimum jQuery UI version - %s. Please update WordPress to 3.5 or higher.", 'motopress-content-editor'), MPCERequirements::MIN_JQUERY_VER, MPCERequirements::MIN_JQUERYUI_VER) . '</p></div>';
}

function motopressCEIsMBStringEnabledNotice() {
    global $motopressCESettings;
    echo '<div class="error"><p>' . sprintf(__("%s error: contact your hosting provider to enable mbstring extension.", 'motopress-content-editor'), $motopressCESettings['brand_name']) . '</p></div>';
}
