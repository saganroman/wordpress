    ...
    public function setContent($content) {
        if (is_string($content)) {
            ...
            if (!empty($content)) {
                ...
                $this->addError('content', __("Value should not be empty", 'motopress-content-editor'));
            }
        } else {
            $this->addError('content', sprintf(__("Invalid argument type - %s", 'motopress-content-editor'), gettype($content)));
        }
    }
