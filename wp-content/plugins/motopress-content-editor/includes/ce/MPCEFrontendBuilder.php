...
//		add_action( 'mpce_frontend_editor_footer', 'wp_auth_check_html' );
	...
	public function motopressCEHTML() {
		...
		$saveObjectTemplateBtnTitle = __('Save Object Template', 'motopress-content-editor');
		$savePageTemplateBtnTitle = __('Save Page Template', 'motopress-content-editor');
		$showLeftBarTitle = __('Add', 'motopress-content-editor');

		$duplicateBtnTitle = __( "Duplicate Object", 'motopress-content-editor' );
	...
	public function enqueueScripts() {
		...
		$topEditorData = array(
			...
			'postData'            => array(
				...
				'postTypeLabel' => get_post_type() ==
				                   'page' ? __( "Page", 'motopress-content-editor' ) : __( "Post", 'motopress-content-editor' ),
		...
		if ( $sendback &&
			...
			$sendbackText = __('Go back', 'motopress-content-editor');
		} else {
			...
			$sendbackText = sprintf( __( 'Go to %s', 'motopress-content-editor' ), get_post_type_object( $postType )->labels->all_items );
		}
