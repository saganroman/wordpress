...
function mpceRunScene() {
    try {
        ...
        (function ($) {
            can.Control('CE.Scene', {
                ...
                init: function init() {
                    ...
                    var leftbarWrapper = $('<div />', { class: 'mpce-leftbar-wrapper' });
                    $('body').prepend(leftbarWrapper);
                    new CE.LeftBar(leftbarWrapper);
                    new CE.DragDrop();
                    new CE.Selectable();
                    new CE.Link();
                    this.addSectionPanelEl = $('<section />', { class: 'mpce-add-section-panel' });
        ...
        (function ($) {
            CE.SceneEvents.EntityCreated = CE.SceneEvents.EntityEvent.extend({ NAME: 'scene.entity.created' }, {});
            CE.SceneEvents.EntityDuplicated = CE.SceneEvents.EntityEvent.extend({ NAME: 'scene.entity.duplicated' }, {});
            CE.SceneEvents.EntityDeleted = CE.SceneEvents.EntityEvent.extend({ NAME: 'scene.entity.deleted' }, {});
            CE.SceneEvents.EntityMoved = CE.SceneEvents.EntityEvent.extend({ NAME: 'scene.entity.moved' }, {});
            CE.SceneEvents.EntityResized = CE.SceneEvents.EntityEvent.extend({ NAME: 'scene.entity.resized' }, {});
            CE.SceneEvents.EntitySettingsChanged = CE.SceneEvents.EntitySettingsEvent.extend({ NAME: 'scene.entity_settings.changed' }, {});
            CE.SceneEvents.EntityStylesChanged = CE.SceneEvents.EntitySettingsEvent.extend({ NAME: 'scene.entity_styles.changed' }, {});
            CE.SceneEvents.StylePresetDeleted = CE.SceneEvents.StylePresetEvent.extend({ NAME: 'scene.style_preset.deleted' }, {});
            CE.SceneEvents.StylePresetRenamed = CE.SceneEvents.StylePresetEvent.extend({ NAME: 'scene.style_preset.renamed' }, {});
            CE.SceneEvents.StylePresetClassChanged = CE.SceneEvents.StylePresetEvent.extend({ NAME: 'scene.style_preset.class_changed' }, {
                oldClass: '',
            ...
            CE.SceneEvents.StylePresetCreated = CE.SceneEvents.StylePresetEvent.extend({ NAME: 'scene.style_preset.created' }, {});
            CE.SceneEvents.StylePresetChanged = CE.SceneEvents.StylePresetEvent.extend({ NAME: 'scene.style_preset.changed' }, {});
            CE.SceneEvents.InlineEditorOpened = CE.SceneEvents.InteractionEvent.extend({ NAME: 'scene.inline_editor.opened' }, {});
            CE.SceneEvents.InlineEditorClosed = CE.SceneEvents.InteractionEvent.extend({ NAME: 'scene.inline_editor.closed' }, {});
            CE.SceneEvents.sceneInited = CE.SceneEvents.Event.extend({ NAME: 'scene.scene.inited' }, {});
            CE.SceneEvents.SnapshotApplied = CE.SceneEvents.Event.extend({ NAME: 'scene.snapshot.applied' }, {
                snapshot: null,
            ...
            CE.SceneEvents.SnapshotTakenBefore = CE.SceneEvents.Event.extend({ NAME: 'scene.snapshot.taken_before' }, {
                init: function init() {}
            });
        })(jQuery);
        (function ($) {
            CE.SceneEvents.ContentChanged = parent.CE.EventDispatcher.Event.extend({ NAME: 'scene.content.changed' }, {
                event: null,
        ...
        (function ($) {
            CE.ShortcodeStyle = can.Construct( 
            {
                ...
                generateCSS: function generateCSS(className, settings, emulateMode) {
                    if ((typeof emulateMode === 'undefined' ? 'undefined' : _typeof(emulateMode)) === undefined) emulateMode = false;
            ...
            }, 
            {
                ...
                init: function init(id, settings, css, options) {
                    options = $.extend({ objectType: '' }, options);
                    this.id = id;
        ...
        (function ($) {
            ...
            }, 
            {
                ...
                stylesWrapper: null,
                clone: function clone() {
                    return new CE.ShortcodePrivateStyle(this.className, $.extend(true, {}, this.settings), this.css, { objectType: this.objectType });
                },
        ...
        (function ($) {
            ...
            { myThis: null }, 
            {
                ...
                createPrivateStyle: function createPrivateStyle(settings, name, objectType) {
                    ...
                    this.privateStyles[name] = new CE.ShortcodePrivateStyle(name, settings, null, { objectType: objectType });
                ...
                mergeStylesToNewPreset: function mergeStylesToNewPreset(obj) {
                    ...
                    var presetOptions = { objectType: privateStyleObj.getObjectType() };
        ...
        (function ($) {
            CE.Shortcode('CE.Controls', {}, {
                ...
                restoreClone: function restoreClone($elementClone) {
                    ...
                    this.settingsCtrl.restoreClone({ 'formsMainCtrl': this });
                    this.stylesCtrl.restoreClone({ 'formsMainCtrl': this });
                },
                setupForms: function setupForms() {
                    this.settingsForms = $('<div />', { 'class': 'motopress-settings-forms' });
                    this.settingsCtrl = new parent.CE.SettingsControlsForm(this.settingsForms, { 'formsMainCtrl': this });
                    this.styleForms = $('<div />', { 'class': 'motopress-style-forms' });
                    this.stylesCtrl = new parent.CE.StyleControlsForm(this.styleForms, { 'formsMainCtrl': this });
                },
        ...
        (function ($) {
            CE.Controls('CE.InlineEditor', {
                    ...
                    var _initEditor = function _initEditor() {
                        ...
                        tinyMCE.init({
                            ...
                            init_instance_callback: function init_instance_callback(editor) {
                                $this.contentObserver = can.compute(editor.getContent({ format: 'html' }));
                ...
                afterBlur: function afterBlur() {
                    this.contentObserver(this.editor.getContent({ format: 'html' }));
                },
            ...
            CE.Controls('CE.CodeEditor', {}, 
            {
                ...
                open: function open() {
                    ...
                    if (typeof content !== 'undefined') {
                        ...
                        if (editor !== null) editor.setContent(content, { format: 'html' });
            ...
            CE.LayoutManager = can.Construct({
                ...
                _insertRenderedWidget: function _insertRenderedWidget(data, $insertMarker, position) {
                    ...
                    if (position == 'in') {
                        ...
                        var newSizes = CE.DragDrop.myThis.recalcRowSizes($rowTo, { insertPosition: insertPos });
                        if (newSizes.length) {
                ...
                insertWidgetToPosition: function insertWidgetToPosition(span, insertMarker, handleName, isNewBlock) {
                    ...
                    switch (handleName) {
                        ...
                        case 'intermediate':
                            ...
                            var newSizes = CE.DragDrop.myThis.recalcRowSizes(rowTo, { insertPosition: toPos });
                            if (newSizes.length) {
                        ...
                        case 'left-in':
                            var rowToSpans = parent.MP.Utils.getEdgeRow(rowTo).children('.motopress-clmn');
                            var newSizes = CE.DragDrop.myThis.recalcRowSizes(rowTo, { wrapperPosition: rowToSpans.index(insertMarker) });
                            if (newSizes.length) {
                                var wrapperSpan = CE.DragDrop.myThis.spanHtml.clone().addClass(parent.MP.Utils.getSpanClass(insertMarker.prop('class').split(' ')));
                                insertMarker.before(wrapperSpan);
                                var innerRow = CE.DragDrop.myThis.rowInnerHtml.clone().find('.motopress-filler-content').replaceWith(insertMarker).end();
        ...
        (function ($) {
            can.Construct.extend('CE.HelpersManager', { myThis: null }, {
        ...
        (function ($) {
            can.Control.extend('CE.Panels.BaseObjectHelper', {
                ...
                setup: function setup(el, args) {
                    ...
                    args = $.extend({ toolsWrapperTag: 'span' }, args);
                ...
                initToolsWrapper: function initToolsWrapper() {
                    this.toolsWrapper = $('<' + this.options.toolsWrapperTag + '/>', { 'class': 'mpce-tools-wrapper' });
                },
        ...
        (function ($) {
            CE.Panels.SimpleColumnHelper('CE.Panels.EmptyColumnHelper', {}, {
                ...
                initOverlay: function initOverlay() {
                    this.overlay = $('<div />', { 'class': 'motopress-overlay' });
        ...
        (function ($) {
            CE.Panels.BaseColumnHelper('CE.Panels.WrapperColumnHelper', {
                ...
                setup: function setup(el, options) {
                    ...
                    options = $.extend({ toolsWrapperTag: 'section' }, options);
        ...
        (function ($) {
            CE.Panels.BaseObjectHelper('CE.Panels.RowHelper', {
                ...
                '{helpersContainer} >.mpce-tools-wrapper .mpce-panel-btn-save click': function helpersContainerMpceToolsWrapperMpcePanelBtnSaveClick(el, e) {
                    e.preventDefault();
                    e.stopPropagation();
                    var saveObjectPromise = parent.CE.SaveObjectModal.myThis.showModal({ categories: parent.CE.ObjectTemplatesLibrary.myThis.getRowCategories() });
                ...
                '{helpersContainer} >.mpce-tools-wrapper .mpce-panel-btn-add click': function helpersContainerMpceToolsWrapperMpcePanelBtnAddClick(el, e) {
                    ...
                    var addSectionPanelEl = $('<section />', { class: 'mpce-add-section-panel' });
                    this.element.before(addSectionPanelEl);
                    var nestingLvl = parent.MP.Utils.detectRowNestingLvl(this.element);
                    var addSectionParameters = { layoutDialog: parent.CE.Panels.LayoutChooserDialog.myThis };
                    if (nestingLvl == 1) {
        ...
        (function ($) {
            CE.Panels.BaseObjectHelper('CE.Panels.WidgetHelper', {}, {
                ...
                '{helpersContainer} >.mpce-tools-wrapper .mpce-panel-btn-save click': function helpersContainerMpceToolsWrapperMpcePanelBtnSaveClick(el, e) {
                    e.preventDefault();
                    e.stopPropagation();
                    var saveObjectPromise = parent.CE.SaveObjectModal.myThis.showModal({ categories: parent.CE.ObjectTemplatesLibrary.myThis.getWidgetCategories() });
                    saveObjectPromise.done(this.proxy(function (objectTemplateAtts) {
                        var category = objectTemplateAtts.category;
                        if (objectTemplateAtts.hasOwnProperty('newCategoryTitle')) {
        ...
        (function ($) {
            ...
            { myThis: null }, 
            {
                ...
                lineHelpers: {
                    intermediate: $('<div />', { 'class': 'motopress-line-helper-intermediate' }),
                    leftOut: $('<div />', { 'class': 'motopress-line-helper-left-out' }),
                    rightOut: $('<div />', { 'class': 'motopress-line-helper-right-out' }),
                    left: $('<div />', { 'class': 'motopress-line-helper-left' }),
                    right: $('<div />', { 'class': 'motopress-line-helper-right' }),
                    leftIn: $('<div />', { 'class': 'motopress-line-helper-left-in' }),
                    rightIn: $('<div />', { 'class': 'motopress-line-helper-right-in' }),
                    topIn: $('<div />', { 'class': 'motopress-line-helper-top-in' }),
                    bottomIn: $('<div />', { 'class': 'motopress-line-helper-bottom-in' }),
                    handleMiddle: $('<div />', { 'class': 'motopress-line-helper-middle-in' }),
                    insert: $('<div />', { 'class': 'motopress-line-helper-insert' })
                },
                textHelpers: {
                    intermediate: $('<div />', {
                        ...
                        if (!rowChildren.length) {
                            ...
                            rowChildren.parentsUntil('.motopress-content-wrapper', '.motopress-clmn').each(function () {
                                ...
                                if (children.length === 1 && (siblings.length || parentWrapper.length)) {
                                    ...
                                    row = action === 'remove' ? { row: replacementSpan.parent() } : null;
                                }
                            });
                        }
                    }
                ...
                resize: function resize(rowFrom, block, type, newSizes) {
                    newSizes = (typeof newSizes === 'undefined' ? 'undefined' : _typeof(newSizes)) === 'object' ? newSizes : {};
            ...
            can.Control.extend('CE.Panels.AddSectionPanel', {}, {
                ...
                init: function init(el, args) {
                    ...
                    if (args.permanent) {
                        ...
                        el.append($('<span />', { class: 'mpce-close fa fa-close' }));
                    }
                },
                restoreClone: function restoreClone($elementClone) {
                    this.element = $elementClone;
