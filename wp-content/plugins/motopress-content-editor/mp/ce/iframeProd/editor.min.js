var _typeof="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(w){return typeof w}:function(w){return w&&"function"===typeof Symbol&&w.constructor===Symbol&&w!==Symbol.prototype?"symbol":typeof w};
...
c+" !important;"));break;case "background-position":"custom"!==c&&b.push(CE.ShortcodeStyle.generateStyleRule(a,c+" !important;"));break;case "border-radius":b.push(CE.ShortcodeStyle.generateStyleRule("-webkit-"+a,c+" !important;"));b.push(CE.ShortcodeStyle.generateStyleRule("-moz-"+a,c+" !important;"));b.push(CE.ShortcodeStyle.generateStyleRule(a,c+" !important;"));break;default:b.push(CE.ShortcodeStyle.generateStyleRule(a,c+" !important;"))}});return b},generateCSS:function(a,b,d){void 0===("undefined"===
typeof d?"undefined":_typeof(d))&&(d=!1);null===a&&(a="%className%");var e=d;d=!1;var f="";b.hasOwnProperty("up")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.up),function(b,c){f+="."+a+c;d&&(f+="."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"up"+c)});b.hasOwnProperty("hover")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.hover),function(b,d){e&&(f+="."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"hover"+d);f+="."+a+":hover"+d});b.hasOwnProperty("tablet")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.tablet),
function(b,c){f=d?f+("."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"tablet"+c):f+("@media (max-width: 768px) { ."+a+c+"}")});b.hasOwnProperty("mobile")&&c.each(CE.ShortcodeStyle.generateStateCSS(b.mobile),function(b,c){f=d?f+("."+a+"."+CE.ShortcodeStyle.previewStateClassPrefix+"mobile"+c):f+("@media (max-width: 320px) { ."+a+c+"}")});return f},generateStyleRule:function(a,b){var d=":not(."+motopressCE.styleEditor["const"].prefixRuleDisable+a+"){";c.isArray(b)||(b=[b]);c.each(b,function(){d+=
a+":"+this});return d+="}"},previewStateClassPrefix:"motopress-ce-preview-state-"},{settings:null,css:null,objectType:"",emulateCSS:null,id:null,init:function(a,b,d,e){e=c.extend({objectType:""},e);this.id=a;this.objectType=e.objectType;this.settings=can.isPlainObject(b)?b:{};"string"===typeof d?(this.css=d,this.emulateCSS=CE.ShortcodeStyle.generateCSS(this.getClassName(),this.settings,!0)):this.regenerateCSS();this.detectStyleTag();this.updateStyleTag()},clone:function(){throw Error("Must be implemented in sub-class!");
...
u[q]):(v=1,t=h[s],0<h[s]&&k.is("[data-motopress-wrapper-id]")&&(b.isAllowedColSize(r,t)||(v=-1)),u[q]=(m+u[q])*v);c(this).data("mp-snap-grid",u);b.currentI=p;b.curSplitterArea="";var x,y={involvedElements:{}};k.length&&(r=k.find(".motopress-block-content > [data-motopress-shortcode]"),r.length&&r.each(function(){x=c(this).attr("data-motopress-shortcode");y.involvedElements.hasOwnProperty(x)||(y.involvedElements[x]=[]);y.involvedElements[x].push(this)}));l.length&&(r=l.find(".motopress-block-content > [data-motopress-shortcode]"),
r.length&&r.each(function(){x=c(this).attr("data-motopress-shortcode");y.involvedElements.hasOwnProperty(x)||(y.involvedElements[x]=[]);y.involvedElements[x].push(this)}));c("body").trigger("MPCEObjectSplitStart",y)},stop:function(a,d){CE.Utils.removeSceneAction("split");CE.LeftBar.myThis.enable();b.showSplitters();c(this).removeClass("motopress-splitter-hover");var l=c(this).closest(".motopress-clmn"),h=l.prev(".motopress-clmn");CE.Resizer.myThis.updateSplittableOptions(l,null,null,"split");var k=
...
if(d.length>parent.CE.Iframe.myThis.gridObj.row.col)return!1;e={};-1<c.inArray(b,["left-out","left","intermediate"])&&(e.insertPosition=d.index(a));-1<c.inArray(b,["right-out","right"])&&(e.insertPosition=d.index(a)+1);-1<c.inArray(b,["left-in","right-in"])&&(e.wrapperPosition="left-in"==b?d.index(a):d.index(a)+1);e=this.recalcRowSizes(a.closest(".motopress-row"),e);return 0<e.length},resize:function(a,b,c,e){e="object"===("undefined"===typeof e?"undefined":_typeof(e))?e:{};null!==a&&"undefined"!==
typeof a&&CE.LayoutManager.rearrangeSpans(a,e.from);"insert"!==c&&(a=b.parent(),CE.LayoutManager.rearrangeSpans(a,e.to))},getSpanSizeRules:function(a){return this.spanSizeRules.hasOwnProperty(a)?this.spanSizeRules[a]:[]},generateSpanSizeRules:function(){for(var a=parent.CE.Iframe.myThis.gridObj.row.col,b=[],c=1;c<=a;c++){b[c]=[];for(var e=Math.floor(a/c),f=a%c,g=1;g<=c;g++)b[c].push(g<=f?e+1:e)}this.spanSizeRules=b},setCalcWrapperWidth:function(a){if(CE.Grid.myThis.padding){var b=2*CE.Grid.myThis.padding,
c="";parent.MP.Utils.Browser.Mozilla?c="-moz-":parent.MP.Utils.Browser.Chrome&&(c="-webkit-");a.css("width",c+"calc(100% - "+b+"px)")}},hideOuterHandles:function(){c(".motopress-outer-handle").addClass("motopress-outer-handle-hidden")},showOuterHandles:function(){c(".motopress-outer-handle").removeClass("motopress-outer-handle-hidden")},onDrag:function(){var a=CE.Scene.myThis.container.find(".motopress-droppable-hover");if(a.length){if(a=a.attr("data-motopress-position"),null!==a){var a=".motopress-line-helper-"+
a+", .motopress-text-helper-"+a,b=this.helperContainer.children();b.not(a).hide();b.filter(a).show()}}else this.helperContainer.children().hide()}})}(jQuery),function(c){CE.Selectable=can.Construct({myThis:null,scrollY:0,focusFlag:!1,blurFlag:!1,setScrollY:function(a){CE.Selectable.scrollY=a},focusWithoutScroll:function(a){if(!CE.Selectable.focusFlag){CE.Selectable.focusFlag=!0;a.focus();window.scrollTo(0,CE.Selectable.scrollY);var b=setTimeout(function(){CE.Selectable.focusFlag=!1;clearTimeout(b)},
0)}return a},blurWithoutScroll:function(a){if(!CE.Selectable.blurFlag){CE.Selectable.blurFlag=!0;a.blur();window.scrollTo(0,CE.Selectable.scrollY);var b=setTimeout(function(){CE.Selectable.blurFlag=!1;clearTimeout(b)},0)}return a},getFocusAreaBySelected:function(a){var b=parent.MP.Utils.getEntityTypeByElement(a);return b.is_row?parent.MP.Utils.getEdgeRow(a).find("> .mpce-row-tools-wrapper > .motopress-focus-area"):b.is_clmn?parent.MP.Utils.getEdgeSpan(a).find("> .motopress-focus-area"):a.siblings(".motopress-focus-area")}},
{selectedClass:"motopress-selected",init:function(){CE.Selectable.myThis=this;c(document).mousedown(function(){CE.Selectable.setScrollY(window.scrollY)});c(document).mouseup(function(){CE.Selectable.setScrollY(window.scrollY)});this.makeSelectable()},isHandleForSelected:function(a){a.closest(".mpce-panel-btn-settings").length&&(a=a.closest(".mpce-panel-btn-settings"));if(!a.hasClass("mpce-panel-btn-settings"))return!1;var b=this.getSelected();return b.length?b.is(this.getShortcodeByHandle(a)):!1},
makeSelectable:function(){parent.CE.EventDispatcher.Dispatcher.addListener(CE.SceneEvents.SnapshotApplied.NAME,this.proxy(CE.Selectable.myThis.unselect))},detectSelectHandleType:function(a){var b="";return b=a.closest(".mpce-object-panel.mpce-row-panel").length?"row":a.closest(".mpce-object-panel.mpce-clmn-panel").length?"span":"widget"},selectShortcode:function(a){a=a.hasClass("motopress-row")?parent.MP.Utils.getEdgeRow(a).find(">.mpce-row-tools-wrapper>.mpce-row-panel>.mpce-panel-btn-settings"):
a.hasClass("motopress-clmn")?parent.MP.Utils.getEdgeSpan(a).find(">.mpce-clmn-tools-wrapper>.mpce-clmn-panel>.mpce-panel-btn-settins"):a.siblings(".mpce-widget-tools-wrapper").find(">.mpce-widget-panel>.mpce-panel-btn-settings");this.select(a)},select:function(a){this.unselect();var b=null;CE.Selectable.focusWithoutScroll(a.siblings(".motopress-focus-area"));b=this.detectSelectHandleType(a);"row"===b?(a.closest(".motopress-row").addClass(this.selectedClass),b=a.closest(".motopress-row")):("span"===
b?a.closest(".motopress-clmn").addClass(this.selectedClass):a.closest(".motopress-clmn").children(".motopress-block-content").addClass(this.selectedClass),b=a.closest(".motopress-clmn"));CE.Utils.addSceneAction("select");(b.hasClass("ce_controls")||b.hasClass("ce_inline_editor")||b.hasClass("ce_code_editor")||b.hasClass("motopress-row"))&&!parent.CE.Panels.SettingsDialog.myThis.element.dialog("isOpen")&&parent.CE.Panels.SettingsDialog.myThis.open(a)},selectWidgetOfSpan:function(a){a=parent.MP.Utils.getEdgeSpan(a);
this.select(a.find(">.motopress-block-content>.mpce-tools-wrapper>.mpce-object-panel>.mpce-panel-btn-settings"))},selectWidget:function(a){a=a.closest(".motopress-clmn");this.selectWidgetOfSpan(a)},showWidgetMainEditTool:function(a){var b=a.control(CE.Controls);b instanceof CE.InlineEditor||b instanceof CE.CodeEditor?b.open():this.selectWidget(a)},unselect:function(){parent.CE.Panels.SettingsDialog.myThis.close();var a=c(".motopress-content-wrapper ."+this.selectedClass);a.length&&(a.each(function(){c(this).removeClass(CE.Selectable.myThis.selectedClass)}),
CE.Selectable.blurWithoutScroll(CE.Selectable.getFocusAreaBySelected(a)));CE.Utils.removeSceneAction("select")},getSelected:function(){var a=c(parent.MP.Utils.convertClassesToSelector(this.selectedClass));parent.MP.Utils.getEntityTypeByElement(a).is_widget&&(a=a.children("[data-motopress-shortcode]"));return a},getShortcodeByHandle:function(a){var b=this.detectSelectHandleType(a);return"row"==b?a.closest(".motopress-row"):"span"==b?a.closest(".motopress-clmn"):a.closest(".motopress-clmn").find(".motopress-block-content").first().children("[data-motopress-shortcode]")}})}(jQuery),
function(c){can.Control.extend("CE.Panels.AddSectionPanel",{},{layoutDialog:null,templateDialog:null,permanent:!1,init:function(a,b){b.layoutDialog&&(a.append(c("<button />",{"class":"mpce-add-section-btn",text:"Add Section"})),this.layoutDialog=b.layoutDialog);b.templateDialog&&(a.append(c("<button />",{"class":"mpce-add-template-btn",text:"Add Template"})),this.templateDialog=b.templateDialog);b.permanent?(this.permanent=!0,this.element.addClass("mpce-permanent-add-section-panel")):a.append(c("<span />",
{"class":"mpce-close fa fa-close"}))},restoreClone:function(a){this.element=a},hide:function(){this.element.hide()},show:function(){this.element.show()},".mpce-add-section-btn click":function(a,b){b.preventDefault();b.stopPropagation();this.layoutDialog.open({positionTarget:this.element,insertMarker:this.element}).then(this.proxy(function(){this.permanent||this.element.remove()}))},".mpce-add-template-btn click":function(a,b){b.preventDefault();b.stopPropagation();this.templateDialog.open({positionTarget:this.element,
insertMarker:this.element}).then(this.proxy(function(){this.permanent||this.element.remove()}))},".mpce-close click":function(){this.element.remove()}})}(jQuery),function(c){c.hasOwnProperty("stellar")&&c.stellar("refresh");c.hasOwnProperty("fn")&&c.fn.hasOwnProperty("button")&&c.fn.button.hasOwnProperty("noConflict")&&(c.fn.btn=c.fn.button.noConflict());new CE.Utils;new CE.Scene;parent.MP.Editor.myThis.load()}(jQuery),jQuery(document).ready(function(c){parent.CE.EventDispatcher.Dispatcher.addListener(CE.SceneEvents.SnapshotTakenBefore.NAME,
function(a){c(".motopress-tabs-obj").each(function(){try{if(c(this).data("uiTabs")){var a=c(this).tabs("option");c(this).data("mpceUiOptions",a);c(this).tabs("destroy")}}catch(d){}});c(".motopress-flexslider").each(function(){try{var a=c(this).data("flexslider");if(a){var d=c.extend({},a.vars,!0);c(this).data("mpceFlexSliderOptions",d);c(this).flexslider("destroy")}}catch(e){}})});parent.CE.EventDispatcher.Dispatcher.addListener(parent.CE.LocalRevision.Events.RevisionPicked.NAME,function(a){c(".motopress-tabs-obj").each(function(){try{var a=
c(this).data("mpceUiOptions");can.isPlainObject(a)&&c(this).tabs(a)}catch(d){}});c(".motopress-flexslider").each(function(){try{var a=c(this).data("mpceFlexSliderOptions");can.isPlainObject(a)&&c(this).flexslider(a)}catch(d){}})})})}catch(w){parent.MP.Error.log(w,!0)}};
