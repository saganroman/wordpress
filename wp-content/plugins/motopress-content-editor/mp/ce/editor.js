        ...
        (function ($) {
            ...
            CE.LocalRevision.Manager = can.Construct({
                ...
                init: function init() {
                    ...
                    return;
                    this.sceneManager = new CE.LocalRevision.SceneManager();
                    CE.EventDispatcher.Dispatcher.addListener(IframeCE.SceneEvents.sceneInited.NAME, this.proxy('onContentChange'));
                    CE.EventDispatcher.Dispatcher.addSubscriber(new ContentChangesSubscriber(this.proxy('onContentChange')));
                },
                getList: function getList() {
