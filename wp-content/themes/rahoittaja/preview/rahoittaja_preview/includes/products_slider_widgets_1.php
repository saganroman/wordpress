...
function theme_set_slider_wrapper($widget_id, $one_row) {
    ...
    $slider_wrapper[$widget_id] = array(
        'before' => '<div class="data-control-id-771689 bd-grid-41"><div class="container-fluid"><div class="separated-grid row"><div
...
function theme_products_slider_block($title = '', $content = '', $class = '', $id = '') {
    ...
    ob_start();
?>
    <div class="data-control-id-3547 bd-productsslider-1">
...
?>
                <div class="<?php echo $item_class; ?>">
                    <div class="data-control-id-3534 bd-griditem-2">
                        <?php theme_do_action('woocommerce_before_shop_loop_item', array(
                            array('woocommerce_template_loop_product_link_open', 10) // 2.1.0
                        )); ?>
                        <a class="data-control-id-200 bd-productimage-2" href="<?php echo $product_view['link']; ?>"><?php theme_product_image($product_view, 'data-control-id-62241 bd-imagestyles-15', ''); ?></a>
	
		<?php if (time() - get_option('theme_products_newness_period') * 60 * 60 * 24 < strtotime(get_the_time('Y-m-d'))) { ?>
<div class="data-control-id-202 bd-productnewicon-4 bd-productnew-1">
    <span><?php _e('New!', 'woocommerce'); ?></span>
</div>
<?php } ?>
	
		<?php if ($product->is_on_sale()): ?>
<div class="data-control-id-204 bd-productsaleicon bd-productsale-1">
...
?>
        <div class="data-control-id-206 bd-productoutofstockicon bd-productoutofstock-1">
            <span>
...
?>
		...
		<?php if ( isset($product_view['link']) && isset($product_view['title']) ){ ?><div class="data-control-id-207 bd-producttitle-4"><a href="<?php echo $product_view['link']; ?>"><?php echo $product_view['title']; ?></a></div><?php } ?>
	
		<div class="data-control-id-277 bd-productprice-2">
<?php
...
?>
        <span class="price"><?php
            echo theme_price_html(array(
                ...
                'old_price' => array(
                    'wrap_start'        => '<span class="data-control-id-276 bd-pricetext-6">',
                    'wrap_end'          => '</span>',
                    'label_class'       => false,
                    'label_attributes'  => '',
                    'amount_class'      => 'data-control-id-275 bd-container-8 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
                    'amount_attributes' => '',
                ),
                'price' => array(
                    'wrap_start'        => '<span class="data-control-id-242 bd-pricetext-5">',
                    'wrap_end'          => '</span>',
                    'label_class'       => false,
                    'label_attributes'  =>'',
                    'amount_class'      => 'data-control-id-241 bd-container-13 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table',
                    'amount_attributes' => '',
                ),
            )); ?>
        </span>
...
?>
		...
		<?php theme_product_buy('data-control-id-282 bd-productbuy-1 bd-no-margins bd-button', ' '); ?>
...
?>
    ...
    <a class="data-control-id-3544 bd-carousel-2" href="#">
