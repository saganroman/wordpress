...
?>
    ...
    theme_print_sidebar_content($current_sidebar_content, 'primary', 'data-control-id-925 bd-primarywidgetarea-2 clearfix', '');
?>
 ...
 $theme_hide_sidebar_area ||
            ...
            <aside class="bd-sidebararea-5-column hidden-xs data-control-id-1121259 bd-flex-vertical bd-flex-fixed <?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
        ...
        <?php else: ?>
            <?php if ($area_content
 && !$theme_hide_sidebar_area): ?>
                <aside class="bd-sidebararea-5-column hidden-xs data-control-id-1121259 bd-flex-vertical bd-flex-fixed">
                    <div class="bd-sidebararea-5 hidden-xs bd-flex-wide  bd-contentlayout-offset">
