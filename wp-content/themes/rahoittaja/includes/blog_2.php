...
?>
    ...
    echo '<h2 class=" bd-container-17 bd-tagstyles bd-custom-blockquotes">' . $title . '</h2>';
}
?>
...
?>
<div class=" bd-postcontent-2 bd-tagstyles bd-custom-blockquotes entry-content bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
