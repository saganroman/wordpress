...
?>
        <div  id="product-<?php the_ID(); ?>" <?php post_class(" bd-productoverview"); ?>>
...
<h2 class=" bd-productoverviewtitle-1 bd-no-margins"><?php echo $product_view['title']; ?></h2>
<?php endif; ?>
...
?>
        <span class="price"><?php
            echo theme_price_html(array(
                ...
                'show_old_price'   => true,
                'old_price' => array(
                    'wrap_start'        => '<span class=" bd-pricetext-15">',
                    'wrap_end'          => '</span>',
                ...
                'price' => array(
                    'wrap_start'        => '<span class=" bd-pricetext-14">',
                    'wrap_end'          => '</span>',
                    'label_class'       => false,
                    'label_attributes'  =>'',
