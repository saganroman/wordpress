...
<body <?php body_class(' hfeed bootstrap bd-body-7  bd-pagebackground-105 bd-margins'); /*   */ ?>>
<header class=" bd-headerarea-1 bd-margins">
        <div class="bd-containereffect-28 container-effect container "><section class=" bd-section-3 bd-tagstyles " id="section3" data-section-title="">
 ...
 col-sm-4">
    <div class="bd-layoutcolumn-135 bd-column" ><div class="bd-vertical-align-wrapper"><a class="bd-imagelink-28  bd-own-margins "  href="https://rahoittaja.sillipilvi.fi">
...
?>
 ...
 col-sm-3">
    <div class="bd-layoutcolumn-78 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-customhtml-8 bd-tagstyles bd-custom-button">
    <div class="bd-container-inner bd-content-element">
        <?php
echo <<<'CUSTOM_CODE'
<div align="right">
...
<div class="bd-contentlayout-7   bd-sheetstyles  bd-no-margins bd-margins" >
    ...
    <div class=" bd-content-12 bd-no-margins">
    ...
    <?php else: ?>
        <div class="bd-containereffect-18 container-effect container "><div class=" bd-layoutcontainer-39  bd-columns bd-no-margins">
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row ">
...
?>
 ...
 col-sm-2">
    <div class="bd-layoutcolumn-28 bd-column" ><div class="bd-vertical-align-wrapper"></div></div>
		...
		<div class="bd-containereffect-19 container-effect container "><div class=" bd-layoutcontainer-28  bd-columns bd-no-margins">
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row ">
...
<img class=" bd-imagestyles" src="<?php echo theme_get_image_path('images/0811348b020f5e46b471ecd50d81a0e0_youtube.svg'); ?>">
		...
		<div class="bd-containereffect-20 container-effect container "><div class=" bd-layoutbox-52  bd-no-margins clearfix">
    <div class="bd-container-inner">
