...
<body <?php body_class('data-control-id-31 hfeed bootstrap bd-body-7  bd-pagebackground-105 bd-margins'); /*   */ ?>>
...
?>
		...
		<div class="bd-containereffect-2 container-effect container data-control-id-1541511">
...
<div class="bd-contentlayout-7   bd-sheetstyles data-control-id-378 bd-no-margins bd-margins" >
    ...
    <div class="data-control-id-1537173 bd-pagetitle-2">
    <div class="bd-container-inner">
        <h1><?php echo theme_get_page_title(); ?></h1>
    </div>
</div>
	
		<div class="data-control-id-369417 bd-content-12 bd-no-margins">
