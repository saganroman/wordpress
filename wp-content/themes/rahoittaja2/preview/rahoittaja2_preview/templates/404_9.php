...
<body <?php body_class('data-control-id-43 hfeed bootstrap bd-body-9  bd-pagebackground bd-margins'); /*   */ ?>>
...
<div class="bd-contentlayout-9  bd-sheetstyles data-control-id-1147787 bd-no-margins bd-margins" >
 ...
 <?php theme_sidebar_area_5(); ?>
    ...
    <p class="data-control-id-1545070 bd-textblock-3 bd-content-element">
    <?php
echo <<<'CUSTOM_CODE'
Hakemaasi sivua ei valitettavasti löytynyt tällä osoitteella.<br>Kokeile uudestaan&nbsp;etusivun&nbsp;kautta.
 ja linkki sanasta etusivu rahoittaja.fi
CUSTOM_CODE;
?>
</p>
</div>
