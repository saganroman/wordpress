...
?>
    <div class="data-control-id-1984 bd-blog-4 bd-page-width ">
        <div class="bd-container-inner">
        
            <div class="bd-containereffect-11 container-effect container data-control-id-1548633"><?php
...
?>
                        ...
                        <div class="separated-item-25 col-md-12 ">
                            ...
                            <div class="bd-griditem-25">
                                <article id="<?php echo $id; ?>" class="data-control-id-1906 bd-article-5 clearfix hentry <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
    <?php
...
?>
<div class="data-control-id-235136 bd-postcontent-9 bd-tagstyles entry-content bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
