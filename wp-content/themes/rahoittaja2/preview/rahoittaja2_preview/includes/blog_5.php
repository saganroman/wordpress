...
?>
                        ...
                        <div class="separated-item-28 col-md-6 col-sm-6 ">
                            ...
                            <div class="bd-griditem-28">
                                <article id="<?php echo $id; ?>" class="data-control-id-2190 bd-article-6 clearfix hentry <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
    <div class="data-control-id-1506724 bd-hoverbox-3 bd-effect-over-left">
  <div class="bd-slidesWrapper">
    <div class="bd-backSlide"><div class="data-control-id-1506710 bd-container-77 bd-tagstyles">
    <?php echo theme_get_post_thumbnail(array(
    
    'class' => 'data-control-id-1492007 bd-postimage-5 bd-imagescaling bd-imagescaling-2',
    'img_class' => 'data-control-id-1491994 bd-imagestyles-33',
    'attributes' => '',
    'img_attributes' => '',
)); ?>
	
		<div class="data-control-id-1506452 bd-layoutbox-7 bd-no-margins clearfix">
    <div class="bd-container-inner">
        <?php
...
?>
<div class="data-control-id-1507958 bd-postcontent-16 bd-tagstyles entry-content bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
...
?>
    ...
    <div class="bd-overSlide"
        ...
        ><div class="data-control-id-1506722 bd-container-79 bd-tagstyles">
