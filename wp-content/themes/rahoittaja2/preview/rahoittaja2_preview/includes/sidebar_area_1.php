...
?>
    ...
    theme_print_sidebar_content($current_sidebar_content, 'primary', 'data-control-id-1479942 bd-primarywidgetarea-71 clearfix', '');
?>
 ...
 $theme_hide_sidebar_area ||
            ...
            <aside class="bd-sidebararea-1-column data-control-id-1479571 bd-flex-vertical bd-flex-fixed <?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
        ...
        <?php else: ?>
            <?php if ($area_content
 && !$theme_hide_sidebar_area): ?>
                <aside class="bd-sidebararea-1-column data-control-id-1479571 bd-flex-vertical bd-flex-fixed">
                    <div class="bd-sidebararea-1 bd-flex-wide  bd-contentlayout-offset">
