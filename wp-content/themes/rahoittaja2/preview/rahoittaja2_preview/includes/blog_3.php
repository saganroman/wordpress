...
?>
    <div class="data-control-id-1735 bd-blog-3 bd-no-margins">
...
?>
                        ...
                        <div class="separated-item-21 col-md-12 col-xs-12 ">
                        
                            <div class="bd-griditem-21">
                                <article id="<?php echo $id; ?>" class="data-control-id-1657 bd-article-4 clearfix hentry <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
    <?php
...
?>
<div class="data-control-id-1555 bd-postcontent-3 bd-tagstyles entry-content bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
